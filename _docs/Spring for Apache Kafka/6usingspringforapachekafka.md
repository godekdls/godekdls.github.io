...
- [Container factory](https://docs.spring.io/spring-kafka/reference/kafka/container-factory.html)
- [Thread Safety](https://docs.spring.io/spring-kafka/reference/kafka/thread-safety.html)
- [Monitoring](https://docs.spring.io/spring-kafka/reference/kafka/micrometer.html)
