...
description: 스프링 시큐리티에서 @RegisteredOAuth2AuthorizedClient 어노테이션으로 OAuth2AuthorizedClient, 액세스 토큰을 리졸브하는 방법을 설명합니다. 공식 문서에 있는 "@RegisteredOAuth2AuthorizedClient" 챕터를 한국어로 번역한 문서입니다.
